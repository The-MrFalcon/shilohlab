         ...
         <div class="row g-0 mx-lg-0">
             <div class="col-lg-6 rast pe-lg-5 wow bounceInLeft " data-wow-delay="1.2s">
                 <div class="position-relative ps-lg-0 h-100">
                     <img class="position-absolute img-fluid rounded w-100 h-100" src="img/2-Ex.png" style="object-fit: cover;" alt="">
                 </div>
             </div>
             <div class="col-lg-6 text-center feature-text py-5 wow fadeIn" data-wow-delay="0.1s">
                 <div class="p-lg-5 p-lg-0">
                     <p class="d-inline-block border border-dark rounded-pill text-dark py-1 px-4">Rast</p>
                     <h3 class="mb-4">Com a ShilohLab você pode fazer seus exames de RAST</h3>
